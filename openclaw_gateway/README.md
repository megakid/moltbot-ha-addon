...
- 🔒 **SSH Tunnel** — Secure remote access for OpenClaw.app or CLI
...
1) In Home Assistant UI:
   ...
   - Add: `https://github.com/megakid/openclaw-ha-addon`
...
- [Add-on GitHub](https://github.com/megakid/openclaw-ha-addon)
